...
public class SongEntry implements Comparable<SongEntry> {
    ...
    /**
     * It will decrement count by 1. It will return false when count is less than 1.
     *
     * @return When the count is decreased by 1.
     */
    ...
    /**
     * It will get the current amount of items.
     *
